...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      helpText("Ingrese el prefijo original del ID:"),
      textInput("prefix_old_rsc", "Prefijo original:", value = "IS-RSC"),
      
      helpText("Ingrese el nuevo prefijo con el que desea reemplazar el original:"),
      textInput("prefix_new_rsc", "Nuevo prefijo:", value = "IS_RESISTENTE"),
      
      helpText("Por favor, ingrese el prefijo original del segundo ID:"),
      textInput("prefix_old_ssc", "Prefijo original:", value = "IS-SSC"),
      
      helpText("Ingrese el nuevo prefijo con el que desea reemplazar el original en los ID's secundarios:"),
      textInput("prefix_new_ssc", "Nuevo prefijo:", value = "IS_SUSCEPTIBLE"),
