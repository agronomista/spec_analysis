...
####test para unir archivos csv archivos
# Lee los archivos CSV
archivo1 <- read.csv("C:/Users/Usuario/Desktop/no_chapeado_ischaemum.csv", header = FALSE, sep = ";")
archivo2 <- read.csv("C:/Users/Usuario/Desktop/chapeado_ischaemum.csv",  header = FALSE, sep = ";")

# Une los archivos por filas
union_vertical <- rbind(archivo1, archivo2)

# Guarda el archivo combinado
write.csv(union_vertical, "union_vertical.csv", row.names = FALSE)
